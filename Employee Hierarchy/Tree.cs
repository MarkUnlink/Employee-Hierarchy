...
{
    class Tree<T> : IGraph<T> where T : IComparable<T>
    {
        /// <summary>
        /// INSTANCE VARIABLES
        /// </summary>
        ...
        public Tree(uint initialCapacity)
        {
            _edgesCount = 0;
        ...
        /// <summary>
        /// Helper function. Checks if edge exist in empTree.
        /// </summary>
        ...
        /// <summary>
        /// Returns true, if empTree is directed; false otherwise.
        /// </summary>
        ...
        /// <summary>
        /// Returns true, if empTree is weighted; false otherwise.
        /// </summary>
        ...
        /// <summary>
        /// An enumerable collection of all directed unweighted edges in empTree.
        /// </summary>
        ...
        {
            if (!HasVertex(vertex))
                throw new KeyNotFoundException("Vertex doesn't belong to empTree.");
        ...
        /// <summary>
        /// Add a collection of vertices to the empTree.
        /// </summary>
        ...
        /// <summary>
        /// Removes the specified vertex from empTree.
        /// </summary>
        ...
        /// <summary>
        /// Checks whether a vertex exists in the empTree
        /// </summary>
        ...
        /// <summary>
        /// Returns a human-readable string of the empTree.
        /// </summary>
        ...
        /// <summary>
        /// A depth first search traversal of the empTree starting from the first inserted node.
        /// Returns the visited vertices of the empTree.
        /// </summary>
        ...
        /// <summary>
        /// A depth first search traversal of the empTree, starting from a specified vertex.
        /// Returns the visited vertices of the empTree.
        /// </summary>
